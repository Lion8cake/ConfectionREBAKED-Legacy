...
namespace TheConfectionRebirth.Tiles.Trees
{
	public class CreamSnowTree : ModTree
	{
		...
		public override Texture2D GetTexture() {
			return mod.GetTexture("Tiles/Trees/CreamSnowTree");
		}

		public override Texture2D GetTopTextures(int i, int j, ref int frame, ref int frameWidth, ref int frameHeight, ref int xOffsetLeft, ref int yOffset) {
			return mod.GetTexture("Tiles/Trees/CreamSnowTree_Tops");
		}

		public override Texture2D GetBranchTextures(int i, int j, int trunkOffset, ref int frame) {
			return mod.GetTexture("Tiles/Trees/CreamSnowTree_Branches");
		}
	}
}